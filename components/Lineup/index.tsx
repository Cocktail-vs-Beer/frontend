...
export default function Lineup() {
  return (
    <section id="lineup" className="">
      <Title>Line up</Title>
      <p className="text-center text-2xl mt-6">Klaar voor de reveal?</p>
      {/*<div className="md:mt-24 mt-16 flex md:flex-row flex-col md:mx-auto md:w-3/4 w-full gap-4">
        <div className="md:w-1/2 bg-[url('/images/26.jpg')] aspect-square grid-element">
          <p className="font-trainone uppercase text-2xl bg-clip-text bg-gradient-to-r from-white to-lightblue text-transparent w-fit">
            Jaël Ost & Magik
          </p>
          <p>01:30 - 02:30</p>
        </div>
        <div className="flex flex-wrap gap-4 md:w-1/2">
          <div className="bg-[url('/images/proudmich.jpg')] grow basis-0 grid-element sm:h-auto h-[180px]">
            <p className="font-trainone uppercase text-xl bg-clip-text bg-gradient-to-r from-white to-lightblue text-transparent w-fit">
              Proudmich
            </p>
            <p>02:30 - 03:30</p>
          </div>
